...
const WeeklyCalendar = () => {
  ...
  const appointments = [
    { day: 1, hour: 10, duration: 1, title: "Team Meeting" },
    { day: 2, hour: 14, duration: 2, title: "Client Call" },
    { day: 4, hour: 9, duration: 1, title: "Code Review" },
  ];
      ...
      <Card className="glass-card p-4 overflow-hidden">
        <ScrollArea className="h-[600px] w-full">
          <div className="min-w-[800px]">
            ...
            {/* Time slots */}
            {hours.map((hour) => (
              <div key={hour} className="grid grid-cols-8 gap-2 border-t border-border/50">
                ...
                {weekDates.map((_, dayIndex) => {
                  ...
                  return (
                    <div
                      key={dayIndex}
                      className="min-h-[60px] p-2 border-l border-border/30 hover:bg-accent/10 transition-colors relative"
                      style={{
                        background: hour % 2 === 0 
                    ...
                    >
                      {appointment && (
                        <div
                          className="absolute inset-2 bg-primary text-primary-foreground rounded p-2 text-xs font-medium overflow-hidden"
